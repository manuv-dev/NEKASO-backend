...
public interface PaiementRepository extends JpaRepository<Paiement, Long> {
    ...
    @Query("SELECT COUNT(DISTINCT p.contrat.demandeLocation.locataire.id) FROM Paiement p WHERE p.contrat.demandeLocation.bienImmobilier.gestionnaire.id = :gestionnaireId AND p.datePaiement IS NULL")
