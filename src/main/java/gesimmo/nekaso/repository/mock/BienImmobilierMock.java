...
//        photo1.setDateUpload(LocalDateTime.now());
...
//        photo2.setDateUpload(LocalDateTime.now());
...
//        photo3.setDateUpload(LocalDateTime.now());
...
//        photo4.setDateUpload(LocalDateTime.now());
...
//        photo5.setDateUpload(LocalDateTime.now());
...
//        photo6.setDateUpload(LocalDateTime.now());
...
//        photo7.setDateUpload(LocalDateTime.now());
...
//        photo8.setDateUpload(LocalDateTime.now());
...
//        photo9.setDateUpload(LocalDateTime.now());
...
//        photo10.setDateUpload(LocalDateTime.now());
